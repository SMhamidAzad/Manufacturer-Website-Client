...
const Blogs = () => {
    return (
        <div className='mx-8 my-8'>
            <div className='mb-5'>
                <h1 className='text-xl font-medium'>How will you improve the performance of a React Application?</h1>
                ...
                <ul>Understanding how React updates its UI</ul>
                <ul>Windowing or list virtualization in React.</ul>
                <ul> Memoizing React components to prevent unnecessary re-renders</ul>
                <ul>Using the useCallBack, useMemo Hook</ul>
                <ul>We should Keep component state local where necessary.</ul>
            </div>
            <div className='mb-5'>
                <h1 className='text-xl font-medium'> What are the different ways to manage a state in a React application?</h1>
            ...
            <div className='mb-5'>
                <h1 className='text-xl font-medium'> How does prototypical inheritance work?</h1>
                <p>Every object with its methods and properties contains an internal and hidden property known as [[Prototype]]. The Prototypal Inheritance is a feature in javascript used to add methods and properties in objects. It is a method by which an object can inherit the properties and methods of another object. Traditionally, in order to get and set the [[Prototype]] of an object, we use Object.getPrototypeOf and Object.</p>
            </div>
            <div className='mb-5'>
                <h1 className='text-xl font-medium'> Why you do not set the state directly in React. For example, if you have const [products, setProducts] = useState([]). Why you do not set products = [...] instead, you use the setProducts</h1>
            ...
            <div className='mb-5'>
                <h1 className='text-xl font-medium'>What is a unit test? Why should write unit tests?</h1>
